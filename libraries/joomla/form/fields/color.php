...
class JFormFieldColor extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        if ($control == 'simple') {
            ...
            $html   = array();
            $html[] = '<select data-chosen="true" name="' . $this->name . '" id="' . $this->id . '"' . $disabled . $required . $class . $position . $onchange . $autofocus . ' style="visibility:hidden;width:22px;height:1px">';
