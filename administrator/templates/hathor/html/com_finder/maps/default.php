	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<fieldset id="filter-bar">
				<legend
					class="element-invisible"><?php echo JText::sprintf('COM_FINDER_SEARCH_LABEL', JText::_('COM_FINDER_MAPS')); ?></legend>
				<div class="filter-search">
					<label class="filter-search-lbl"
					       for="filter_search"><?php echo JText::sprintf('COM_FINDER_SEARCH_LABEL', JText::_('COM_FINDER_MAPS')); ?></label>
				...
				<div class="filter-select">
					<label class="selectlabel"
					       for="filter_branch"><?php echo JText::sprintf('COM_FINDER_FILTER_BY', JText::_('COM_FINDER_MAPS')); ?></label>
				...
				<?php foreach ($this->items as $i => $item) : ?>
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td class="center btns">
							<?php if ((int) $item->num_children === 0) : ?>
								<span
									class="badge <?php if ($item->num_nodes > 0) echo "badge-info"; ?>"><?php echo $item->num_nodes; ?></span>
							<?php else : ?>
								&nbsp;
							<?php endif; ?>
						</td>
