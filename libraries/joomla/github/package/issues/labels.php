...
class JGithubPackageIssuesLabels extends JGithubPackage
{
    ...
    public function getList($owner, $repo)
    {
        ...
        // Send the request.
        return $this->processResponse($response = $this->client->get($this->fetchUrl($path)));
    }
    ...
    public function add($owner, $repo, $number, array $labels)
    {
        ...
        // Send the request.
        return $this->processResponse($this->client->post($this->fetchUrl($path), json_encode($labels)));
    }
    ...
    public function replace($owner, $repo, $number, array $labels)
    {
        ...
        // Send the request.
        return $this->processResponse($this->client->put($this->fetchUrl($path), json_encode($labels)));
    }
