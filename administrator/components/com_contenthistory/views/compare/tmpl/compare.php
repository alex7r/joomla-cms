...
<fieldset>
	<legend>
		...
		<div class="btn-group pull-right">
			&nbsp;
			<button id="toolbar-all-rows" class="btn hasTooltip"
			        title="<?php echo JText::_('COM_CONTENTHISTORY_BUTTON_COMPARE_ALL_ROWS_DESC'); ?>"
			...
			<button id="toolbar-changed-rows" class="btn hasTooltip"
			        title="<?php echo JText::_('COM_CONTENTHISTORY_BUTTON_COMPARE_CHANGED_ROWS_DESC'); ?>"
			...
			<button class="diff-header btn hasTooltip"
				...
				<span class="icon-wrench"></span> <?php echo JText::_('COM_CONTENTHISTORY_BUTTON_COMPARE_HTML'); ?>
			</button>
			...
			<button class="diffhtml-header btn hasTooltip"
				...
				<span class="icon-pencil"></span> <?php echo JText::_('COM_CONTENTHISTORY_BUTTON_COMPARE_TEXT'); ?>
			</button>
		</div>
	</legend>
	<table id="diff" class="table table-striped table-condensed">
		...
		<tr class="<?php echo $rowClass; ?>">
					...
					<?php if ($subValue->value || $newSubValue): ?>
						...
						<tr class="<?php echo $rowClass; ?>">
							...
							<td class="originalhtml"
							    style="display:none"><?php echo htmlspecialchars($subValue->value, ENT_COMPAT, 'UTF-8'); ?></td>
							<td class="changedhtml"
							    style="display:none"><?php echo htmlspecialchars($newSubValue, ENT_COMPAT, 'UTF-8'); ?></td>
			...
			<?php else: ?>
				...
				<td class="changedhtml"
				    style="display:none"><?php echo htmlspecialchars($object2->$name->value, ENT_COMPAT, 'UTF-8'); ?></td>
