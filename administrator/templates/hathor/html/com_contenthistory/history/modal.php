...
$option         = (end($aliasArray) == 'category') ? 'com_categories&amp;extension=' . implode(
        '.',
        array_slice($aliasArray, 0, count($aliasArray) - 1)
    ) : $aliasArray[0];
...
$formUrl        = 'index.php?option=com_contenthistory&view=history&layout=modal&tmpl=component&item_id=' . $this->state->get(
        'item_id'
    ) . '&type_id=' . $this->state->get('type_id') . '&type_alias=' . $this->state->get(
        'type_alias'
...
<div class="modal-body">
    ...
    <div class="modal-buttons">
        <button id="toolbar-load" type="submit" class="btn pointer hasTooltip"
        ...
        <button id="toolbar-preview" type="button" class="btn pointer hasTooltip"
                title="<?php echo JText::_('COM_CONTENTHISTORY_BUTTON_PREVIEW_DESC'); ?>"
                data-url="<?php echo JRoute::_(
                    'index.php?option=com_contenthistory&view=preview&layout=preview&tmpl=component&' . JSession::getFormToken(
                    ) . '=1'
                ); ?>">
            <span class="icon-search"></span><span
                class="hidden-phone"><?php echo JText::_('COM_CONTENTHISTORY_BUTTON_PREVIEW'); ?></span></button>
        <button id="toolbar-compare" type="button" class="btn pointer hasTooltip"
                title="<?php echo JText::_('COM_CONTENTHISTORY_BUTTON_COMPARE_DESC'); ?>"
                data-url="<?php echo JRoute::_(
                    'index.php?option=com_contenthistory&view=compare&layout=compare&tmpl=component&' . JSession::getFormToken(
                    ) . '=1'
                ); ?>">
        ...
        <button
            ...
            class="btn pointer hasTooltip" title="<?php echo JText::_('COM_CONTENTHISTORY_BUTTON_KEEP_DESC'); ?>">
        ...
        <button
            ...
            class="btn pointer hasTooltip" title="<?php echo JText::_('COM_CONTENTHISTORY_BUTTON_DELETE_DESC'); ?>">
                    ...
                    <td class="center">
                        ...
                        <?php else : ?>
                            <a class="btn btn-mini active" rel="tooltip" href="javascript:void(0);"
                               onclick="return listItemTask('cb<?php echo $i; ?>','history.keep')"
                               data-original-title="<?php echo JText::_(
                                   'COM_CONTENTHISTORY_BUTTON_KEEP_TOGGLE_ON'
                               ); ?>">
