...
class JFormFieldModal_Category extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $linkCategories = 'index.php?option=com_categories&amp;view=categories&amp;layout=modal&amp;tmpl=component' . '&amp;extension=' . $extension . '&amp;function=jSelectCategory_' . $this->id;

        $linkCategory = 'index.php?option=com_categories&amp;view=category&amp;layout=modal&amp;tmpl=component' . '&amp;task=category.edit' . '&amp;function=jEditCategory_' . $value;
