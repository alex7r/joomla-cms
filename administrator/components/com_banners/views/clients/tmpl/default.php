...
?>
<form action="<?php echo JRoute::_('index.php?option=com_banners&view=clients'); ?>" method="post" name="adminForm"
      id="adminForm">
				...
				<tr>
					...
					<th width="1%" class="nowrap center hidden-phone hidden-tablet">
						<i class="icon-publish hasTooltip"
						   title="<?php echo JText::_('COM_BANNERS_COUNT_PUBLISHED_ITEMS'); ?>"></i>
					</th>
					<th width="1%" class="nowrap center hidden-phone hidden-tablet">
						<i class="icon-unpublish hasTooltip"
						   title="<?php echo JText::_('COM_BANNERS_COUNT_UNPUBLISHED_ITEMS'); ?>"></i>
					</th>
					<th width="1%" class="nowrap center hidden-phone hidden-tablet">
						<i class="icon-archive hasTooltip"
						   title="<?php echo JText::_('COM_BANNERS_COUNT_ARCHIVED_ITEMS'); ?>"></i>
					</th>
					<th width="1%" class="nowrap center hidden-phone hidden-tablet">
