...
class FOFConfigDomainTables implements FOFConfigDomainInterface
{
    ...
    protected function getTablealias($table, &$configuration, $params, $default = '')
    {
        ...
        if (isset($configuration['tables']['*']) && isset($configuration['tables']['*']['tablealias']) && isset($configuration['tables']['*']['tablealias'][0])) {
            $tablealias = (string)$configuration['tables']['*']['tablealias'][0];
        }

        if (isset($configuration['tables'][$table]) && isset($configuration['tables'][$table]['tablealias']) && isset($configuration['tables'][$table]['tablealias'][0])) {
    ...
    protected function getBehaviors($table, &$configuration, $params, $default = '')
    {
        ...
        if (isset($configuration['tables']['*']) && isset($configuration['tables']['*']['behaviors'])) {
            $behaviors = (string)$configuration['tables']['*']['behaviors'];
        }

        if (isset($configuration['tables'][$table]) && isset($configuration['tables'][$table]['behaviors'])) {
    ...
    protected function getRelations($table, &$configuration, $params, $default = '')
    {
        ...
        if (isset($configuration['tables']['*']) && isset($configuration['tables']['*']['relations'])) {
            $relations = $configuration['tables']['*']['relations'];
        }

        if (isset($configuration['tables'][$table]) && isset($configuration['tables'][$table]['relations'])) {
