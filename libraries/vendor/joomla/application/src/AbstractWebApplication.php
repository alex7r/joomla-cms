...
abstract class AbstractWebApplication extends AbstractApplication
{
    ...
    protected function loadSystemUris($requestUri = null)
    {
        ...
        } else // No explicit base URI was set so we need to detect it.
        {
            ...
            } else // Pretty much everything else should be handled with SCRIPT_NAME.
            {
        ...
        } else // No explicit media URI was set, build it dynamically from the base uri.
        {
