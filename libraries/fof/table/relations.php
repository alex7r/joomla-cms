...
class FOFTableRelations
{
     ...
     * @return  void
     */
    public function addParentRelation(
        $itemName,
        $tableClass = null,
        $localKey = null,
        $remoteKey = null,
     ...
     * @return  void
     */
    protected function normaliseParameters(
        $pivot = false,
        &$itemName,
        &$tableClass,
        &$localKey,
     ...
     */
    public function addMultipleRelation(
        $itemName,
        $tableClass = null,
        $localKey = null,
        $ourPivotKey = null,
     ...
     * @return  void
     */
    protected function addBespokePivotRelation(
        $relationType,
        $itemName,
        $tableClass,
        $localKey,
     ...
     * @return  void
     */
    public function addChildRelation(
        $itemName,
        $tableClass = null,
        $localKey = null,
        $remoteKey = null,
     ...
     * @return  void
     */
    public function addChildrenRelation(
        $itemName,
        $tableClass = null,
        $localKey = null,
        $remoteKey = null,
