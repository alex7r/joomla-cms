                ...
                <table class="table table-striped" id="contactList">
                    ...
                    <tr>
                        ...
                        <th width="5%" class="nowrap hidden-phone">
                            <?php echo JHtml::_('searchtools.sort', 'JFEATURED', 'a.featured', $listDirn,
                                $listOrder); ?>
                        </th>
                        ...
                        <?php if ($assoc) : ?>
                            <th width="5%" class="nowrap hidden-phone hidden-tablet">
                                <?php echo JHtml::_('searchtools.sort', 'COM_CONTACT_HEADING_ASSOCIATION',
                                ...
                                <div class="pull-left">
                                    <?php if ($item->checked_out) : ?>
                                        <?php echo JHtml::_('jgrid.checkedout', $i, $item->editor,
                                            $item->checked_out_time, 'contacts.', $canCheckin); ?>
                                    <?php endif; ?>
