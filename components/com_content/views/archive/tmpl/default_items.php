...
<div id="archive-items">
    <?php foreach ($this->items as $i => $item) : ?>
        ...
        <div class="row<?php echo $i % 2; ?>" itemscope itemtype="https://schema.org/Article">
                    ...
                    <div class="createdby" itemprop="author" itemscope itemtype="https://schema.org/Person">
                        ...
                        <?php if (!empty($item->contact_link) && $params->get('link_author') == true) : ?>
                            <?php echo JText::sprintf(
                                ...
                                JHtml::_('link', $this->item->contact_link, $author, array('itemprop' => 'url'))
                            ); ?>
                        <?php else: ?>
            ...
            <?php $useDefList = ($params->get('show_modify_date') || $params->get('show_publish_date') || $params->get(
                    'show_create_date'
                ) || $params->get('show_hits') || $params->get('show_category') || $params->get(
                                    ...
                                    <div class="modified">
                                        ...
                                        <time datetime="<?php echo JHtml::_('date', $item->modified, 'c'); ?>"
                                            ...
                                            <?php echo JText::sprintf(
                                                ...
                                                JHtml::_('date', $item->modified, JText::_('DATE_FORMAT_LC3'))
                                            ); ?>
                                        </time>
                                    </div>
                                </dd>
                                    ...
                                    <div class="create">
                                        ...
                                        <time datetime="<?php echo JHtml::_('date', $item->created, 'c'); ?>"
                                            ...
                                            <?php echo JText::sprintf(
                                                ...
                                                JHtml::_('date', $item->created, JText::_('DATE_FORMAT_LC3'))
                                            ); ?>
                                        </time>
                                    </div>
                                </dd>
            ...
            <?php if ($params->get('show_intro')) : ?>
                <div class="intro"
                     itemprop="articleBody"> <?php echo JHtml::_(
