    ...
    <?php foreach ($this->modules as $i => &$module) : ?>
        ...
        <tr class="<?php echo $no; ?><?php echo $status; ?>row<?php echo $i % 2; ?>" id="tr-<?php echo $module->id; ?>"
            ...
            <td id="<?php echo $module->id; ?>">
                ...
                <a href="#moduleEdit<?php echo $module->id; ?>Modal" role="button" class="btn btn-link"
                   data-toggle="modal" title="<?php echo JText::_('COM_MENUS_EDIT_MODULE_SETTINGS'); ?>"
            ...
            <?php echo JHtml::_('bootstrap.renderModal', 'moduleEdit' . $module->id . 'Modal', array(
