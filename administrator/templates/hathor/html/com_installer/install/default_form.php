		...
		<div id="j-main-container">
			...
			<div class="width-70 fltlft">
				...
				<fieldset class="uploadform">
					...
					<input type="text" id="install_url" name="install_url" class="input_box" size="70"
					       value="https://"/>
					<input type="button" class="button" value="<?php echo JText::_('COM_INSTALLER_INSTALL_BUTTON'); ?>"
