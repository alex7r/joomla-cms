...
<form action="index.php" method="post" id="languageForm" class="form-horizontal">
    <div class="btn-toolbar">
        <div class="btn-group pull-right">
            <a href="#" class="btn btn-primary" onclick="Install.submitform();"
               title="<?php echo JText::_('JCHECK_AGAIN'); ?>"><span
                    class="icon-refresh icon-white"></span> <?php echo JText::_('JCHECK_AGAIN'); ?></a>
        </div>
    </div>
