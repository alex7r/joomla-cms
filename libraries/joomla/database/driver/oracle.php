...
class JDatabaseDriverOracle extends JDatabaseDriverPdo
{
    ...
    public function dropTable($tableName, $ifExists = true)
    {
        ...
        $query = $this->getQuery(true)->setQuery('DROP TABLE :tableName');
    ...
    public function getTableKeys($table)
    {
        ...
        $table = strtoupper($table);
        $query->select('*')->from('ALL_CONSTRAINTS')->where('table_name = :tableName')->bind(':tableName', $table);
    ...
    public function getTableList($databaseName = null, $includeDatabaseName = false)
    {
        ...
        if ($databaseName) {
            $query->where('owner = :database')->bind(':database', $databaseName);
        }
