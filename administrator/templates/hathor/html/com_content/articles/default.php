...
<form action="<?php echo JRoute::_('index.php?option=com_content&view=articles'); ?>" method="post" name="adminForm"
    ...
    <div id="j-main-container" class="span10">
        ...
        <div id="j-main-container">
                ...
                <tr>
                    ...
                    <?php if ($assoc) : ?>
                        <th width="5%">
                            <?php echo JHtml::_(
                                'grid.sort',
                                'COM_CONTENT_HEADING_ASSOCIATION',
                                'association',
                                $listDirn,
                                $listOrder
                            ); ?>
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td class="break-word">
                            ...
                            <?php if ($canEdit || $canEditOwn) : ?>
                                <a href="<?php echo JRoute::_(
                                    'index.php?option=com_content&task=article.edit&id=' . $item->id
                                ); ?>">
                        ...
                        <td class="center">
                            <?php if ($item->created_by_alias) : ?>
                                ...
                                <p class="smallsub"> <?php echo JText::sprintf(
                                        'JGLOBAL_LIST_ALIAS',
            ...
            <?php if ($user->authorise('core.create', 'com_content') && $user->authorise(
                    'core.edit',
                    'com_content'
