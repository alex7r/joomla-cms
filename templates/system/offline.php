...
<div id="frame" class="outline">
    <?php if ($app->get('offline_image') && file_exists($app->get('offline_image'))) : ?>
        <img src="<?php echo $app->get('offline_image'); ?>"
             alt="<?php echo htmlspecialchars($app->get('sitename'), ENT_COMPAT, 'UTF-8'); ?>"/>
    <?php endif; ?>
    <h1>
    ...
    <?php elseif ($app->get('display_offline_message', 1) == 2 && str_replace(
                                                                      ' ',
                                                                      '',
        ...
        <fieldset class="input">
            ...
            <?php if (count($twofactormethods) > 1) : ?>
                <p id="form-login-secretkey">
                    ...
                    <input type="text" name="secretkey" class="inputbox"
