            ...
            <fieldset id="filter-bar">
                ...
                <div class="filter-select">
                    ...
                    <select name="filter_enabled" id="filter_enabled">
                        ...
                        <?php echo JHtml::_(
                            'select.options',
                            PluginsHelper::publishedOptions(),
                            'value',
                            'text',
                        ...
                        <td>
                            ...
                            <?php if ($canEdit) : ?>
                                <a href="<?php echo JRoute::_(
                                    'index.php?option=com_plugins&task=plugin.edit&extension_id=' . (int)$item->extension_id
                                ); ?>">
