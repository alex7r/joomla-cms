					...
					<tr>
						...
						<th width="1%" class="nowrap center">
							<i class="icon-publish hasTooltip"
							   title="<?php echo JText::_('COM_USERS_COUNT_ENABLED_USERS'); ?>"></i>
							<span class="hidden-phone"><?php echo JText::_('COM_USERS_COUNT_ENABLED_USERS'); ?></span>
						</th>
						<th width="1%" class="nowrap center">
							<i class="icon-unpublish hasTooltip"
							   title="<?php echo JText::_('COM_USERS_COUNT_DISABLED_USERS'); ?>"></i>
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td class="center btns">
								<a class="badge <?php if ($item->count_enabled > 0) echo "badge-success"; ?>"
							...
							<td class="center btns">
								<a class="badge <?php if ($item->count_disabled > 0) echo "badge-important"; ?>"
