...
<head>
	...
	<script type="text/javascript"
	        src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/js/template.js"></script>
	...
	<div id="content">
		...
		<div id="element-box" class="login">
			...
			<div class="login-inst">
				...
				<div id="lock"></div>
				<a href="<?php echo $frontEndUri->toString(); ?>"
				   target="_blank"><?php echo JText::_('COM_LOGIN_RETURN_TO_SITE_HOME_PAGE'); ?></a>
			</div>
			<!-- Login Component -->
			<div class="login-box">
