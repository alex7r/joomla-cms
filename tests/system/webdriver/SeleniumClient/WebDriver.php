...
class WebDriver
{
	...
	{
		return $this->_screenshotsDirectory;
	}
	 ...
	 * @param String $value
	 */
	public function setScreenShotsDirectory($value)
	{
		$this->_screenshotsDirectory = $value;
	}
	...
	public function screenshot($overrideScreenshotsDirectory = null)
	{
		...
		else if (isset($this->_screenshotsDirectory))
		{
	...
	public function findElement(By $locator, $polling = false)
	{
		...
		$result = null;
		if (isset($results["value"]["ELEMENT"]) && trim($results["value"]["ELEMENT"]) != "")
		{
			$result = new WebElement($this, $results["value"]["ELEMENT"]);
		}
	 ...
	 * @return String
	 */
	public function executeScript($script, $args = null)
	{
	 ...
	 * @return String
	 */
	public function executeAsyncScript($script, $args = null)
	{
