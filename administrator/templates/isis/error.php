...
<head>
    ...
    <?php endif; ?>
    <link
        href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/css/template<?php echo($this->direction == 'rtl' ? '-rtl' : ''); ?>.css"
        rel="stylesheet"/>
...
<body class="admin <?php echo $option . " view-" . $view . " layout-" . $layout . " task-" . $task . " "; ?>"
    ...
    <section id="content">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <?php endif; ?>
                <p><a href="<?php echo $this->baseurl; ?>" class="btn"><span
                            class="icon-dashboard"></span> <?php echo JText::_('JGLOBAL_TPL_CPANEL_LINK_TEXT'); ?></a>
                </p>
                <!-- End Content -->
            </div>
        </div>
