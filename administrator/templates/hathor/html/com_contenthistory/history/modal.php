...
$formUrl        = 'index.php?option=com_contenthistory&view=history&layout=modal&tmpl=component&item_id=' . $this->state->get('item_id') . '&type_id=' . $this->state->get('type_id') . '&type_alias=' . $this->state->get('type_alias') . '&' . JSession::getFormToken() . '=1';
        ...
        <table class="adminlist modal">
            ...
            <?php foreach ($this->items as $item) : ?>
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td class="center">
                        <?php echo number_format((int)$item->character_count, 0, JText::_('DECIMALS_SEPARATOR'),
