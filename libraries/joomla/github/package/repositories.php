...
class JGithubPackageRepositories extends JGithubPackage
{
    ...
    public function getListOwn($type = 'all', $sort = 'full_name', $direction = '')
    {
        ...
        $path = '/user/repos' . '?type=' . $type . '&sort=' . $sort . '&direction=' . $direction;
    ...
    public function getListUser($user, $type = 'all', $sort = 'full_name', $direction = '')
    {
        ...
        // Build the request path.
        $path = '/users/' . $user . '/repos' . '?type=' . $type . '&sort=' . $sort . '&direction=' . $direction;
    ...
    public function create(
        ...
        $path = ($org) // Create a repository for an organization
            ? '/orgs/' . $org . '/repos' // Create a repository for a user
            : '/user/repos';
    ...
    public function delete($owner, $repo)
    {
        ...
        // Send the request.
        return $this->processResponse($this->client->delete($this->fetchUrl($path)));
    }
}
