...
?>
<form action="<?php echo JRoute::_('index.php?option=com_search&view=searches'); ?>" method="post" name="adminForm"
      id="adminForm">
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<?php if ($this->state->get('show_results')) : ?>
								...
								<td class="center btns">
									<a class="badge <?php if ($item->returns > 0) echo "badge-success"; ?>"
