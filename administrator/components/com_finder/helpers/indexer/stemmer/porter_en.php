...
class FinderIndexerStemmerPorter_En extends FinderIndexerStemmer
{
    ...
    private static function _cvc($str)
    {
        ...
        return preg_match(
                   ...
                   $matches
                         ...
                         $matches[1]
                     ) == 3 and $matches[1]{2} != 'w' and $matches[1]{2} != 'x' and $matches[1]{2} != 'y';
    }
    ...
    private static function _step2($word)
    {
        switch (substr($word, -2, 1)) {
            case 'a':
                self::_replace($word, 'ational', 'ate', 0) or self::_replace($word, 'tional', 'tion', 0);
                break;
            case 'c':
                self::_replace($word, 'enci', 'ence', 0) or self::_replace($word, 'anci', 'ance', 0);
                break;
            case 'e':
    ...
    private static function _step3($word)
    {
        switch (substr($word, -2, 1)) {
            ...
            case 's':
                ...
                break;
            case 't':
                self::_replace($word, 'icate', 'ic', 0) or self::_replace($word, 'iciti', 'ic', 0);
                break;
            case 'u':
    ...
    private static function _step4($word)
    {
        switch (substr($word, -2, 1)) {
            case 'a':
                ...
                break;
            case 'c':
                self::_replace($word, 'ance', '', 1) or self::_replace($word, 'ence', '', 1);
                break;
            case 'e':
            ...
            case 's':
                ...
                break;
            case 't':
                self::_replace($word, 'ate', '', 1) or self::_replace($word, 'iti', '', 1);
                break;
            case 'u':
